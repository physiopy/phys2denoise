...
Do you want to jump in but don’t exactly know where/how? You can drop a few lines in `gitter <https://gitter.im/phys2denoise/community>`_, so we can help you find something that suits you!
...
------------------------
We’re trying to keep all the conversation related to the project development in GitHub `issues <https://github.com/smoia/phys2denoise/issues>`_.
We maintain a `gitter chat room <https://gitter.im/phys2denoise/community>`_ for more informal conversations and general project updates.
...
Labels
------
The current list of labels are `here <https://github.com/physiopy/phys2denoise/labels>`_. They can be used for **Issues**, **PRs**, or both.
